...
Last updated: 2026-08-09 (Slice 6 panel review and shortlist consensus completed)
...
| 7 — Candidate information request and email outreach | Next | Build approved Sarvam-assisted drafts, provider-neutral Resend/fake email delivery, idempotent sending, reply/bounce/opt-out state, and the candidate communication timeline. |
| 8–11 | Not started | Follow the slice order below. |

### Current handoff

- Start Slice 7 from the latest human `shortlist_decisions` record and its linked application/evaluation. Keep generated drafts, recruiter approval, provider delivery, candidate replies, and confirmed structured profile updates as distinct auditable states.
