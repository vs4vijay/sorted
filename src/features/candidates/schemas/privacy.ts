...
export const CandidatePrivacyRequestStatusSchema = z.enum([
  'requested',
  'approved',
  'completed',
  'declined',
...
export const HostedCandidatePrivacyRequestInputSchema = z
  .object({
...
export type HostedCandidatePrivacyRequestInput = z.infer<
  typeof HostedCandidatePrivacyRequestInputSchema
>;
