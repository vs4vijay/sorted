...
export function SetupForm() {
  ...
  return <form action={action} className="setup-form">
    ...
    <label>Password<span>Use at least 12 characters with a letter and number.</span><input name="password" type="password" autoComplete="new-password" minLength={12} required /></label>
